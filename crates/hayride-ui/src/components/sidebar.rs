...
use crate::views::app::{PromptOptions, PromptOptionsStoreFields};
...
fn SideBarTopButtons() -> impl IntoView {
    view!{
        <div class="flex flex-wrap justify-between">
            <button class="btn btn-ghost justify-start text-primary">
...
fn SideBarBottomButtons() -> impl IntoView {
    ...
    view!{
        <div class="dialog-backdrop absolute bottom-16" class:hidden=move || !dialog_open.get()>
        ...
        <button class="btn btn-ghost" on:click=move |_| set_dialog_open.set(!dialog_open.get())>
            <svg class="size-5"
        ...
        <button class="btn btn-ghost">
            <svg class="size-5" xmlns="http://www.w3.org/2000/svg" fill="none"  viewBox="0 0 97.707 97.707" stroke-width="2" stroke="currentColor">
