    ...
    <div class="flex h-screen w-screen bg-neutral">
        ...
        <input id="chat-settings" type="checkbox" class="drawer-toggle" />
            <div class="drawer-content">
                ...
                <aside class="absolute fixed top-0 right-0 h-full w-64 overflow-y-auto">
                    <div class="flex sticky top-0 right-0 m-4 justify-left space-x-4">
                ...
                <main id="content"  class="bg-neutral flex flex-col flex-1 ml-64 mr-64 overflow-auto">
                    <Router>
            ...
            <div class="drawer-side">
                ...
                <div class="min-h-full w-80 rounded-l-xl border-r-2 bg-base-100">
                    <Config/>
                </div>
            </div>
        </div>
